...
test('Delete User - valid UUID', async ({ request }) => {
  const createUser = await request.post('/Account/v1/User', { data: { userName: username, password } });
...
test('Delete User - nonexistent UUID', async ({ request }) => {
  const response = await request.delete('/Account/v1/User/00000000-0000-0000-0000-000000000000');
